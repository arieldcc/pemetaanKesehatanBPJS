        ...
        <div class="card shadow mb-4">
            <div class="card-header py-2">
                <div class="d-flex justify-content-between align-items-center"> <!-- Tambahkan flexbox untuk alignment -->
                    ...
                    <a href="tambah-layanan" class="btn btn-primary btn-fill btn-wd"> <!-- Hapus float-right jika menggunakan flexbox -->
            ...
            <div class="card-body ">
                ...
                <table class="table table-responsive table-hover table-striped table-wd" width="100%" cellspacing="0" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Tempat Fasilitas Kesehatan</th>
                            <th>Layanan</th>
                            <th>Keterangan</th>
                            <th>Aksi</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/data-layanan/{{ $item->id }}/edit"
