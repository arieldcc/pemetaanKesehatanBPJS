...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body ">
                <form method="POST" action="/data-jadwal/{{ $jadwal->id }}/update" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select class="js-example-basic-single form-control @error('dokter_id') is-invalid @enderror" id="dokter_id" name="dokter_id">
                                ...
                                @foreach ($dokter as $item)
                                    <option value="{{ $item->id }}" {{ $item->id==$jadwal->dokter_id ? 'selected' : '' }}>{{ $item->nama_dokter.' | '.$item->fasilitasKesehatan->nama_fasilitas }}</option>
                                @endforeach
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('hari') is-invalid @enderror" placeholder="Hari Kerja. cth. Senin s/d Jumat" value="{{ $jadwal->hari }}" name="hari" id="hari" disabled>
                            @if ($errors->has('hari'))
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('jam_mulai') is-invalid @enderror" placeholder="Jam Buka. cth: 07.30" value="{{ $jadwal->jam_mulai }}" name="jam_mulai" id="jam_mulai" disabled>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('jam_selesai') is-invalid @enderror" placeholder="Jam Tutup/Selesai" value="{{ $jadwal->jam_selesai }}" name="jam_selesai" id="jam_selesai" disabled>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" rows="4" cols="4" name="keterangan" id="keterangan" disabled>{{ $jadwal->keterangan }}</textarea>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ($('#dokter_id').val() != "") {
                ...
                $.getJSON('/get-dokter/' + $('#dokter_id').val(), function(data) {
