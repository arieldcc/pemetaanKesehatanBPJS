...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body ">
                <form method="POST" action="/simpan-dokter" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Nama Dokter</label>
                            <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" placeholder="Nama Dokter" value="{{ old('nama_dokter') }}" name="nama_dokter" id="nama_dokter">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('spesialis') is-invalid @enderror" placeholder="Spesialis Dokter" value="{{ old('spesialis') }}" name="spesialis" id="spesialis">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control @error('no_telp') is-invalid @enderror" placeholder="Nomor Telp." value="{{ old('no_telp') }}" name="no_telp" id="no_telp">
                        ...
                        <div class="form-group col-md-4">
                            <label>E-Mail</label>
                            <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="E-Mail" value="{{ old('email') }}" name="email" id="email">
                            @if ($errors->has('email'))
