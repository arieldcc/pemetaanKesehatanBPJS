...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body ">
                <form method="POST" action="/simpan-fasilitas" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_fasilitas') is-invalid @enderror" placeholder="Nama Fasilitas" value="{{ old('nama_fasilitas') }}" name="nama_fasilitas" id="nama_fasilitas" disabled>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Alamat</label>
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat" value="{{ old('alamat') }}" name="alamat" id="alamat" disabled>
                        ...
                        <div class="form-group col-md-4">
                            <label>Kota</label>
                            <input type="text" class="form-control @error('kota') is-invalid @enderror" placeholder="Kota" value="{{ old('kota') }}" name="kota" id="kota" disabled>
                            @if ($errors->has('kota'))
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('propinsi') is-invalid @enderror" placeholder="Propinsi" value="{{ old('propinsi') }}" name="propinsi" id="propinsi" disabled>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control @error('kode_pos') is-invalid @enderror" placeholder="Kode Pos" value="{{ old('kode_pos') }}" name="kode_pos" id="kode_pos" disabled>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control @error('no_telp') is-invalid @enderror" placeholder="Nomor Telp." value="{{ old('no_telp') }}" name="no_telp" id="no_telp" disabled>
                        ...
                        <div class="form-group col-md-4">
                            <label>E-Mail</label>
                            <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="E-Mail" value="{{ old('email') }}" name="email" id="email" disabled>
                            @if ($errors->has('email'))
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('latitude') is-invalid @enderror" placeholder="Latitude" value="{{ old('latitude') }}" name="latitude" id="latitude" disabled>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('longitude') is-invalid @enderror" placeholder="Longitude" value="{{ old('longitude') }}" name="longitude" id="longitude" disabled>
